 ...
 * Retorna dois pontos que formam uma linha horizontal que atravessa o fecho inteiro no eixo X.
 *
 * - Análise de complexidade:
 ...
 * line: Line, representando a reta base para cálculo da distância
